...
import { useHookHttp } from './useHookHttp';


export const ComponenteHooks = () => {
    ...
    const [usuario] = useHookHttp(`https://my-json-server.typicode.com/fofomedrano/demo-server/posts/${id}`);
